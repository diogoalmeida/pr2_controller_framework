...
typedef Eigen::Matrix<double, 6, 1> Vector6d;
  ...
  **/
  ...
  private:
    double alpha_force_, beta_force_, alpha_torque_, beta_torque_, f_d_, v_d_amp_, w_d_amp_, v_freq, w_freq, alpha_adapt_t_, alpha_adapt_r_, torque_slack_, normal_bias_;
