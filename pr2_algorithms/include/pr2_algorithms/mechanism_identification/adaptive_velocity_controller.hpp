  ...
  **/
  ...
  public:
    ...
    /**
      ...
      @param twist The estimated twist at the contact point. It should contain an estimate of v_s and w_r.
    ...
    **/
    Vector6d control(const Vector6d &wrench, const Vector6d &twist, double v_d, double w_d, double dt);
  ...
  private:
    double alpha_force_, beta_force_, alpha_torque_, beta_torque_, f_d_, torque_d_, v_d_amp_, w_d_amp_, v_freq, w_freq, alpha_adapt_t_, alpha_adapt_r_, torque_slack_;
